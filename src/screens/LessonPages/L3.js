    ...
    const navigation = useNavigation(); 
        return(
          ...
          >
                ...
                <Image
                    source={require('../../images/CAC.png')}
                    style={styles.topicIcon}
                />
                <Text style={styles.titletxt}>Cyberattacks and Cybersecurity</Text>
                ...
                >
                    ...
                    <View>
                        ...
                        <Chapters
                            ...
                            title="Are You Really Secure? Self-Assessment Security Test - Video"
                            color="#a9aedb"
                            onPress={() => {
                        ...
                        />
                         <Chapters
                            ...
                            title="Why Computer Incidents are so Prevalent - Infographic"
                            color="#a9aedb"
                            onPress={() => {
