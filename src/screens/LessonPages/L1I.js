           ...
           <View>
               <View style={style.containerTop}>
                ...
                <View>
                    <ScrollView>
                        <Image
                            source={require('../../images/intropics/01eap.png')}
                            style={{height:"30%",
                                    width:"100%",
                                    }}
                        />
                        ...
                        <Text style={style.paragraph}>
                                ...
                                What is a profession? A profession is a trade, a business, or an occupation of which one
                                professes to have extensive knowledge acquired through long years of experience and 
                                formal education and the autonomy of and responsibility to make independent
                                ...
                                knowledge in the knowledge domain of that which makes up that occupation or trade. 
                                
                            
                        </Text>
                        <TouchableOpacity
                                onPress={() => {
                                    navigation.navigate("L1L");
                                }}
