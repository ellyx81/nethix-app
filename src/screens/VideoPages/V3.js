...
const V3 = () => {
    ...
    const video = require('../../videos/03.mp4');
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView>
            <Text style={styles.title}>Are You Really Secure? Self-Assessment Security Test</Text>
               ...
               This video provides a simple self-assessment security test that employees and contractors alike should be asked to complete.
               </Text>
            </ScrollView>
        </View>
