...
const V5 = () => {
    ...
    const video = require('../../videos/06.mp4');
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView>
                <Text style={styles.title}>Patent vs. Utility Model: What are the Difference Between the Two?</Text>
               ...
               <Text style={styles.paragraph}>
               What are the main differences between patents and utility models?
               </Text>
            </ScrollView>
        </View>
